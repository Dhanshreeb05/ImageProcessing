 ...
 * getting the red component of the image.
 */
public class RedComponent implements ControllerHelper {
  @Override
    ...
    try {
      ...
      if (imageDict.containsKey(referImageName)) {
        imageDict.put(imageName,
                new GreyscaleImageNew(imageDict.get(referImageName), Channel.red));

        out.append("Command red-component Successfully executed.....\n");
