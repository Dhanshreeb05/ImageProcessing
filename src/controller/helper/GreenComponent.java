 ...
 * the getting the green component of the image.
 */
public class GreenComponent implements ControllerHelper {
  @Override
    ...
    try {
      ...
      if (imageDict.containsKey(referImageName)) {
        imageDict.put(imageName,
                new GreyscaleImageNew((ColorImageNew) imageDict.get(
                        referImageName), Channel.green));

        out.append("Command green-component Successfully executed.....\n");
