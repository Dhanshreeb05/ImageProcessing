 ...
 * the calling the sharpen method  of the image.
 */
public class Sharpen implements ControllerHelper {
  @Override
  public void runHelper(Scanner scan, Appendable out,
    ...
    try {
      ...
      imageDict.put(destination_image_name, imageDict.get(referImageName).sharpen());

      out.append("Command sharpen Successfully executed.....\n");
