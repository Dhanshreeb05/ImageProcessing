 ...
 * the calling the convertToSepia method  of the image.
 */
public class Sepia implements ControllerHelper {
  @Override
  public void runHelper(Scanner scan, Appendable out,
    ...
    try {
      ...
      imageDict.put(destination_image_name, imageDict.get(referImageName).convertToSepia());

      out.append("Command sepia Successfully executed.....\n");
