 ...
 * getting the intensity component of the image.
 */
public class IntensityComponent implements ControllerHelper {
  @Override
    ...
    try {
      ...
      if (imageDict.containsKey(referImageName)) {
        imageDict.put(imageName,
                (new ColorImageNew((ColorImageNew) imageDict.get(referImageName)
                )).convertToGreyscale("intensity"));
        out.append("Command intensity-component Successfully executed.....\n");
